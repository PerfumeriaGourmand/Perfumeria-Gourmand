          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full border border-border-light rounded-xl px-4 py-3 pr-11 font-sans text-sm text-text-dark focus:outline-none focus:border-gold/50 bg-white transition-colors"
                placeholder="••••••••"
              />
              <button
                type="button"
